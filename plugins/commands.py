...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("CAACAgIAAxkBAAITT2Xp4JOyZgSiyoGi-QJsYIC7JoPRAAKHFQACPQ9QSd6bZv3Wx6O_NAQ") 
...
async def stop_button(bot, message):
    ...
    await msg.edit("**✅️ 𝙱𝙾𝚃 𝙸𝚂 𝚁𝙴𝚂𝚃𝙰𝚁𝚃𝙴𝙳. 𝙼𝚊𝚍𝚎 𝚋𝚢 𝚅𝙳𝙼𝙾𝚅𝙸𝙴𝚉**")
